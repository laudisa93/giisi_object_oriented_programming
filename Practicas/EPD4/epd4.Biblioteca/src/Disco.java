...
public class Disco implements IPublicacion, IPrestable, IConsultable {
    ...
    public Disco(int iCodigo, String sAutor, String sTitulo, int iAnio) {
    ...
    public void prestar() {
        ...
        {
            System.out.println("El disco está siendo consultado por lo que no puede ser prestado aún.");
        }
        else
        {
           this.bPrestado = true; 
